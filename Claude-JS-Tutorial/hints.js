/**
 * Hints for JavaScript Tutorial Exercises
 *
 * This file contains helpful hints for each exercise in the JavaScript version
 * of Anthropic's Prompt Engineering Interactive Tutorial.
 */

export const exercise_1_1_hint = `The grading function in this exercise is looking for an answer that contains the exact Arabic numerals "1", "2", and "3".
You can often get Claude to do what you want simply by asking.`;

export const exercise_1_2_hint = `The grading function in this exercise is looking for answers that contain "soo" or "giggles".
There are many ways to solve this, just by asking!`;

export const exercise_2_1_hint = `The grading function in this exercise is looking for any answer that includes the word "hola".
Ask Claude to reply in Spanish like you would when speaking with a human. It's that simple!`;

export const exercise_2_2_hint = `The grading function in this exercise is looking for EXACTLY "Michael Jordan".
...
export const exercise_2_3_hint = `The grading function in this cell is looking for a response that is equal to or greater than 800 words.
Because LLMs aren't great at counting words yet, you may have to overshoot your target.`;

export const exercise_3_1_hint = `The grading function in this exercise is looking for an answer that includes the words "incorrect" or "not correct".
Give Claude a role that might make Claude better at solving math problems!`;

export const exercise_4_1_hint = `The grading function in this exercise is looking for a solution that includes the words "haiku" and "pig".
...
export const exercise_4_2_hint = `The grading function in this exercise is looking for a response that includes the word "brown".
If you surround "{QUESTION}" in XML tags, how does that change Claude's response?`;

export const exercise_4_3_hint = `The grading function in this exercise is looking for a response that includes the word "brown".
...
export const exercise_5_1_hint = `The grading function for this exercise is looking for a response that includes the word "Warrior".
...
export const exercise_5_2_hint = `The grading function looks for a response of over 5 lines in length that includes the words "cat" and "<haiku>".
...
export const exercise_5_3_hint = `The grading function in this exercise is looking for a response that contains the words "tail", "cat", and "<haiku>".
...
export const exercise_6_1_hint = `The grading function in this exercise is looking for the correct categorization letter + the closing parentheses and the first letter of the name of the category, such as "C) B" or "B) B" etc.
...
export const exercise_6_1_solution = `
USER TURN
...
export const exercise_6_2_hint = `The grading function in this exercise is looking for only the correct letter wrapped in <answer> tags, such as "<answer>B</answer>". The correct categorization letters are the same as in the above exercise.
...
export const exercise_7_1_hint = `You're going to have to write some example emails and classify them for Claude (with the exact formatting you want). There are multiple ways to do this. Here are some guidelines below.
...
export const exercise_7_1_solution = `
USER TURN
...
export const exercise_8_1_hint = `The grading function in this exercise is looking for a response that contains the phrase "I do not", "I don't", or "Unfortunately".
What should Claude do if it doesn't know the answer?`;

export const exercise_8_2_hint = `The grading function in this exercise is looking for a response that contains the phrase "49-fold".
...
export const exercise_9_1_solution = `
...
export const exercise_9_2_solution = `
...
export const exercise_10_2_1_solution = `const systemPrompt = systemPromptToolsGeneralExplanation + \`Here are the functions available in JSONSchema format:
...
// Utility function to get a hint by exercise name
export function getHint(exerciseName) {
    const hints = {
        'exercise_1_1': exercise_1_1_hint,
        'exercise_1_2': exercise_1_2_hint,
        'exercise_2_1': exercise_2_1_hint,
        'exercise_2_2': exercise_2_2_hint,
        'exercise_2_3': exercise_2_3_hint,
        'exercise_3_1': exercise_3_1_hint,
        'exercise_4_1': exercise_4_1_hint,
        'exercise_4_2': exercise_4_2_hint,
        'exercise_4_3': exercise_4_3_hint,
        'exercise_5_1': exercise_5_1_hint,
        'exercise_5_2': exercise_5_2_hint,
        'exercise_5_3': exercise_5_3_hint,
        'exercise_6_1': exercise_6_1_hint,
        'exercise_6_2': exercise_6_2_hint,
        'exercise_7_1': exercise_7_1_hint,
        'exercise_8_1': exercise_8_1_hint,
        'exercise_8_2': exercise_8_2_hint,
    };

    return hints[exerciseName] || 'No hint available for this exercise.';
}

// Function to display a hint in the console
export function showHint(exerciseName) {
    console.log('\n💡 HINT:');
    console.log('--------');
    console.log(getHint(exerciseName));
    console.log('--------\n');
}